...
plot_logo_region(seq_path = seq_path_CsgA, region = CsgA_regions[["R1"]])
plot_logo_region(seq_path = seq_path_CsgA, region = CsgA_regions[["R5"]])

plot_logo_region(seq_path = seq_path_CsgB, region = CsgB_regions[["R1"]])
plot_logo_region(seq_path = seq_path_CsgB, region = CsgB_regions[["R5"]])
