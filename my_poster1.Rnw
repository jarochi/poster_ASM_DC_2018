...
legend <- get_legend(A1 + theme(legend.position = "bottom"))
...
plot_grid(A1+theme(legend.position = "none"), B1+theme(legend.position = "none"), 
          ...
          A3+theme(legend.position = "none"), B3+theme(legend.position = "none"), 
          A4+theme(legend.position = "none"), B4+theme(legend.position = "none"), 
          A5+theme(legend.position = "none")+xlab("csgA"), B5+theme(legend.position = "none")+xlab("csgB"), 
          legend, NULL,
          labels = rep(c("R1", "R2", "R3", "R4", "R5"), each = 2), nrow = 6, ncol = 2, align = "h")

# plot_grid(B1, B2, B3, B4, B5, labels = c("R1", "R2", "R3", "R4", "R5"), nrow = 5, align = "h")
